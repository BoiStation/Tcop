  ...
  extends BaseController
{
  ...
  {
    com.tcop.entity.Message localMessage = (com.tcop.entity.Message)this.IIIlllIl.find(draftMessageId);
  ...
  {
    if (!validateValue(com.tcop.entity.Message.class, "content", content, new Class[0])) {
      return "/shop/common/error";
    }
    Member localMember1 = this.IIIllllI.getCurrent();
    com.tcop.entity.Message localMessage1 = (com.tcop.entity.Message)this.IIIlllIl.find(draftMessageId);
    ...
    com.tcop.entity.Message localMessage2 = new com.tcop.entity.Message();
    ...
    {
      IIIllIlI(redirectAttributes, com.tcop.Message.success("shop.member.message.saveDraftSuccess", new Object[0]));
      return "redirect:draft.jhtml";
    }
    IIIllIlI(redirectAttributes, com.tcop.Message.success("shop.member.message.sendSuccess", new Object[0]));
  ...
  {
    com.tcop.entity.Message localMessage = (com.tcop.entity.Message)this.IIIlllIl.find(id);
  ...
  public String reply(Long id, String content, HttpServletRequest request, RedirectAttributes redirectAttributes)
  {
    ...
    com.tcop.entity.Message localMessage1 = (com.tcop.entity.Message)this.IIIlllIl.find(id);
    ...
    IIIllIlI(redirectAttributes, com.tcop.Message.success("shop.member.message.replySuccess", new Object[0]));
    return "redirect:list.jhtml";
  }
  ...
  @ResponseBody
  public com.tcop.Message delete(Long id)
  {
    Member localMember = this.IIIllllI.getCurrent();
 ...
 * Qualified Name:     com.tcop.controller.shop.member.MessageController
