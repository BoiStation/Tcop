  ...
  extends BaseController
{
  ...
  {
    if (!IIIllIlI(com.tcop.entity.Message.class, "content", content, new Class[0])) {
    ...
    {
      IIIllIlI(redirectAttributes, com.tcop.Message.success("admin.message.saveDraftSuccess", new Object[0]));
      return "redirect:draft.jhtml";
    }
    IIIllIlI(redirectAttributes, com.tcop.Message.success("admin.message.sendSuccess", new Object[0]));
  ...
  public String reply(Long id, String content, HttpServletRequest request, RedirectAttributes redirectAttributes)
  {
    ...
    IIIllIlI(redirectAttributes, com.tcop.Message.success("admin.message.replySuccess", new Object[0]));
    return "redirect:list.jhtml";
  }
  ...
  @ResponseBody
  public com.tcop.Message delete(Long[] ids)
  {
    if (ids != null) {
 ...
 * Qualified Name:     com.tcop.controller.admin.MessageController
