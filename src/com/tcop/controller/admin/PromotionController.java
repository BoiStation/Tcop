...
import com.tcop.entity.GiftItem;
import com.tcop.entity.Product;
import com.tcop.entity.Promotion;
import com.tcop.entity.Promotion.Operator;
...
public class PromotionController extends BaseController
{
  ...
  public String save(Promotion promotion, Long memberRankIds[], Long productCategoryIds[], Long brandIds[], Long couponIds[], Long productIds[], RedirectAttributes redirectAttributes)
  {
      ...
      if(promotion.getStartPrice() != null && promotion.getEndPrice() != null && promotion.getStartPrice().compareTo(promotion.getEndPrice()) > 0)
          return "/admin/common/error";
      if(promotion.getPriceOperator() == com.tcop.entity.Promotion.Operator.divide && promotion.getPriceValue() != null && promotion.getPriceValue().compareTo(new BigDecimal(0)) == 0)
          return "/admin/common/error";
      if(promotion.getPointOperator() == com.tcop.entity.Promotion.Operator.divide && promotion.getPointValue() != null && promotion.getPointValue().compareTo(new BigDecimal(0)) == 0)
      {
          return "/admin/common/error";
      } else
      {
