...
import com.tcop.entity.ProductImage;
...
import com.tcop.service.FileService;
import com.tcop.service.GoodsService;
import com.tcop.service.MemberRankService;
import com.tcop.service.ProductCategoryService;
import com.tcop.service.ProductImageService;
...
public class ProductController extends BaseController
{
  ...
  public String add(ModelMap model)
  {
      ...
      model.addAttribute("tags", IIlIIIlI.findList(com.tcop.entity.Tag.Type.product));
  ...
  public String save(Product product, Long productCategoryId, Long brandId, Long tagIds[], Long specificationIds[], HttpServletRequest request, RedirectAttributes redirectAttributes)
  {
      for(Iterator iterator = product.getProductImages().iterator(); iterator.hasNext();)
      {
          ...
          if(productimage1.getFile() != null && !productimage1.getFile().isEmpty() && !IIlIIlll.isValid(com.tcop.FileInfo.FileType.image, productimage1.getFile()))
          {
          ...
          RedirectAttributes redirectAttributes)
  {
      for(Iterator iterator = product.getProductImages().iterator(); iterator.hasNext();)
      {
          ...
          if(productimage.getFile() != null && !productimage.getFile().isEmpty() && !IIlIIlll.isValid(com.tcop.FileInfo.FileType.image, productimage.getFile()))
          {
              IIIllIlI(redirectAttributes, Message.error("admin.upload.invalid", new Object[0]));
          ...
          Boolean isGift, Boolean isOutOfStock, Boolean isStockAlert, Pageable pageable, ModelMap model)
  {
      ...
      model.addAttribute("page", IIIlllIl.findPage(productcategory, brand, promotion, list1, null, null, null, isMarketable, isList, isTop, isGift, isOutOfStock, isStockAlert, com.tcop.entity.Product.OrderType.dateDesc, pageable));
