  ...
  implements ArticleService, DisposableBean
{
  ...
  public long viewHits(Long id)
  {
    ...
    {
    	long1 = (Long)localElement.getObjectValue();
    }
    else
    {
      ...
      long1 = localArticle.getHits();
    }
    long1 = Long.valueOf(long1.longValue() + 1L);
    localEhcache.put(new Element(id, long1));
 ...
 * Qualified Name:     com.tcop.service.impl.ArticleServiceImpl
