  ...
  implements StaticService, ServletContextAware
{
  ...
  public int build(Article article)
  {
    ...
    delete(article);
    com.tcop.Template localTemplate = this.IIIlllIl.get("articleContent");
    int i = 0;
  ...
  public int build(Product product)
  {
    ...
    delete(product);
    com.tcop.Template localTemplate = this.IIIlllIl.get("productContent");
    int i = 0;
  ...
  {
    com.tcop.Template localTemplate = this.IIIlllIl.get("index");
  ...
  {
    int i = 0;
    com.tcop.Template localTemplate1 = this.IIIlllIl.get("sitemapIndex");
    com.tcop.Template localTemplate2 = this.IIIlllIl.get("sitemap");
    HashMap localHashMap = new HashMap();
  ...
  {
    int i = 0;
    com.tcop.Template localTemplate1 = this.IIIlllIl.get("shopCommonJs");
    com.tcop.Template localTemplate2 = this.IIIlllIl.get("adminCommonJs");
 ...
 * Qualified Name:     com.tcop.service.impl.StaticServiceImpl
