...
import com.tcop.Setting.StockAllocationTime;
...
import com.tcop.entity.Deposit.Type;
...
public class OrderServiceImpl extends BaseServiceImpl<Order, Long> implements OrderService {
  ...
  @Transactional(readOnly=true)
  public List<Order> findList(Member member, Integer count, List<Filter> filters, List<com.tcop.Order> orders)
  {
