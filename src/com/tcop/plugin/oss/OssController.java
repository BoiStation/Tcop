package com.tcop.plugin.oss;

import java.math.BigDecimal;
import javax.annotation.Resource;
import com.tcop.Message;
import com.tcop.controller.admin.BaseController;
...
public class OssController extends BaseController {
	...
	public String install(RedirectAttributes redirectAttributes) {
		...
		if (!this.IIIlllIl.getIsInstalled()) {
			...
			pluginconfig.setPluginId(this.IIIlllIl.getId());
 ...
 * 
 * Qualified Name: com.tcop.plugin.oss.OssController
 * 
