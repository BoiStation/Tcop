...
public class ProductListDirective
  extends BaseDirective
{
  ...
  public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body)
  {
    ...
    if(arrayOfLong != null){
    	System.out.println("arrayOfLong is : " + arrayOfLong.toString());
    }
    ...
    if(localList1 == null){
    	System.out.println("localList1 is null !!!!!!!!!!!!");
    } 
 ...
 * Qualified Name:     com.tcop.template.directive.ProductListDirective
