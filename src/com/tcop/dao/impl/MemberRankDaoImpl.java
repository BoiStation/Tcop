  ...
  implements MemberRankDao
{
  public boolean nameExists(String name)
  {
    ...
    Long localLong = (Long)this.entityManager.createQuery(str, Long.class).setFlushMode(FlushModeType.COMMIT).setParameter("name", name).getSingleResult();
  ...
  public boolean amountExists(BigDecimal amount)
  {
    ...
    Long localLong = (Long)this.entityManager.createQuery(str, Long.class).setFlushMode(FlushModeType.COMMIT).setParameter("amount", amount).getSingleResult();
    return localLong.longValue() > 0L;
  }
  ...
  public MemberRank findDefault()
  {
    try
    {
      ...
      return (MemberRank)this.entityManager.createQuery(str, MemberRank.class).setFlushMode(FlushModeType.COMMIT).getSingleResult();
    }
  ...
  public MemberRank findByAmount(BigDecimal amount)
  {
    ...
    return (MemberRank)this.entityManager.createQuery(str, MemberRank.class).setFlushMode(FlushModeType.COMMIT).setParameter("amount", amount).setMaxResults(1).getSingleResult();
  }
  ...
  public MemberRank merge(MemberRank memberRank)
  {
    ...
    if (memberRank.getIsDefault().booleanValue())
    {
      ...
      this.entityManager.createQuery(str).setFlushMode(FlushModeType.COMMIT).setParameter("memberRank", memberRank).executeUpdate();
    }
  ...
  public void remove(MemberRank memberRank)
  {
    if ((memberRank != null) && (!memberRank.getIsDefault().booleanValue()))
    {
      ...
      List localList = this.entityManager.createQuery(str, Product.class).setFlushMode(FlushModeType.COMMIT).setParameter("memberRank", memberRank).getResultList();
 ...
 * Qualified Name:     com.tcop.dao.impl.MemberRankDaoImpl
