...
public class AreaDaoImpl
  extends BaseDaoImpl<Area, Long>
  implements AreaDao
{
  public List<Area> findRoots(Integer count)
  {
    String str = "select area from Area area where area.parent is null order by area.order asc";
    TypedQuery localTypedQuery = this.entityManager.createQuery(str, Area.class).setFlushMode(FlushModeType.COMMIT);
    if (count != null) {
 ...
 * Qualified Name:     com.tcop.dao.impl.AreaDaoImpl
