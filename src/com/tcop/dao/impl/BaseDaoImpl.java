...
import com.tcop.Filter.Operator;
import com.tcop.Order;
import com.tcop.Order.Direction;
import com.tcop.Page;
import com.tcop.Pageable;
import com.tcop.dao.BaseDao;
import com.tcop.entity.OrderEntity;
...
public abstract class BaseDaoImpl<T, ID extends Serializable> implements BaseDao<T, ID> {
  ...
  public List<T> findList(Integer first, Integer count, List<Filter> filters, List<com.tcop.Order> orders)
  {
  ...
  protected List<T> IIIllIlI(CriteriaQuery<T> paramCriteriaQuery, Integer paramInteger1, Integer paramInteger2, List<Filter> paramList, List<com.tcop.Order> paramList1)
  {
  ...
  protected Page<T> IIIllIlI(CriteriaQuery<T> paramCriteriaQuery, Pageable paramPageable)
  {
    ...
    if (paramCriteriaQuery.getOrderList().isEmpty())
      if (OrderEntity.class.isAssignableFrom(this.clazz))
        ...
        paramCriteriaQuery.orderBy(new javax.persistence.criteria.Order[] { localCriteriaBuilder.desc(localRoot.get("createDate")) });
    long l = IIIllIlI(paramCriteriaQuery, (List)(null)).longValue();
  ...
  private void IIIlllII(CriteriaQuery<T> paramCriteriaQuery, List<com.tcop.Order> paramList)
  {
    if ((paramCriteriaQuery == null) || (paramList == null) || (paramList.isEmpty()))
      return;
    Root localRoot = IIIllIlI(paramCriteriaQuery);
    ...
    while (localIterator.hasNext())
    {
      com.tcop.Order localOrder = (com.tcop.Order)localIterator.next();
