...
public class DeliveryTemplateDaoImpl
  extends BaseDaoImpl<DeliveryTemplate, Long>
  implements DeliveryTemplateDao
{
  public DeliveryTemplate findDefault()
  {
    try
    {
      ...
      return (DeliveryTemplate)this.entityManager.createQuery(str, DeliveryTemplate.class).setFlushMode(FlushModeType.COMMIT).getSingleResult();
    }
  ...
  public DeliveryTemplate merge(DeliveryTemplate deliveryTemplate)
  {
    ...
    if (deliveryTemplate.getIsDefault().booleanValue())
    {
      ...
      this.entityManager.createQuery(str).setFlushMode(FlushModeType.COMMIT).setParameter("deliveryTemplate", deliveryTemplate).executeUpdate();
    }
 ...
 * Qualified Name:     com.tcop.dao.impl.DeliveryTemplateDaoImpl
