...
public class DeliveryCenterDaoImpl
  extends BaseDaoImpl<DeliveryCenter, Long>
  implements DeliveryCenterDao
{
  public DeliveryCenter findDefault()
  {
    try
    {
      ...
      return (DeliveryCenter)this.entityManager.createQuery(str, DeliveryCenter.class).setFlushMode(FlushModeType.COMMIT).getSingleResult();
    }
  ...
  public DeliveryCenter merge(DeliveryCenter deliveryCenter)
  {
    ...
    if (deliveryCenter.getIsDefault().booleanValue())
    {
      ...
      this.entityManager.createQuery(str).setFlushMode(FlushModeType.COMMIT).setParameter("deliveryCenter", deliveryCenter).executeUpdate();
    }
 ...
 * Qualified Name:     com.tcop.dao.impl.DeliveryCenterDaoImpl
