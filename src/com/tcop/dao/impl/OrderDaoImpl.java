...
public class OrderDaoImpl extends BaseDaoImpl<com.tcop.entity.Order, Long> implements OrderDao
{
  public com.tcop.entity.Order findBySn(String sn)
  {
    if (sn == null) {
      return null;
    }
    ...
    try
    {
      return (com.tcop.entity.Order)this.entityManager.createQuery(str, com.tcop.entity.Order.class).setFlushMode(FlushModeType.COMMIT).setParameter("sn", sn).getSingleResult();
    }
    catch (NoResultException localNoResultException) {}
    return null;
  }
  
  public List<com.tcop.entity.Order> findList(Member member, Integer count, List<Filter> filters, List<com.tcop.Order> orders)
  {
    if (member == null) {
      return Collections.emptyList();
    }
    CriteriaBuilder localCriteriaBuilder = this.entityManager.getCriteriaBuilder();
    CriteriaQuery localCriteriaQuery = localCriteriaBuilder.createQuery(com.tcop.entity.Order.class);
    Root localRoot = localCriteriaQuery.from(com.tcop.entity.Order.class);
  ...
  public Page<com.tcop.entity.Order> findPage(Member member, Pageable pageable)
  {
    if (member == null) {
  ...
  public Page<com.tcop.entity.Order> findPage(Order.OrderStatus orderStatus, Order.PaymentStatus paymentStatus, Order.ShippingStatus shippingStatus, Boolean hasExpired, Pageable pageable)
  {
    CriteriaBuilder localCriteriaBuilder = this.entityManager.getCriteriaBuilder();
    CriteriaQuery localCriteriaQuery = localCriteriaBuilder.createQuery(com.tcop.entity.Order.class);
    Root localRoot = localCriteriaQuery.from(com.tcop.entity.Order.class);
  ...
  public void releaseStock()
  {
    ...
    List localList = this.entityManager.createQuery(str, com.tcop.entity.Order.class).setParameter("isAllocatedStock", Boolean.valueOf(true)).setParameter("now", new Date()).getResultList();
    if (localList != null)
    {
      Iterator localIterator1 = localList.iterator();
      while (localIterator1.hasNext())
      {
        com.tcop.entity.Order localOrder = (com.tcop.entity.Order)localIterator1.next();
 ...
 * Qualified Name:     com.tcop.dao.impl.OrderDaoImpl
