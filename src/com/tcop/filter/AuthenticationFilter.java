...
public class AuthenticationFilter extends FormAuthenticationFilter {
	...
	protected AuthenticationToken createToken(ServletRequest servletRequest, ServletResponse servletResponse) {
		String username = getUsername(servletRequest);		//�û���
		String password = getPassword(servletRequest);		//����
		String captchaId = getCaptchaId(servletRequest);	//��֤��ͼƬ
		String captcha = getCaptcha(servletRequest);		//��֤������
		boolean rememberMe = isRememberMe(servletRequest);	//�Ƿ񱣴��½��Ϣ
		String host = getHost(servletRequest);				//��½IP
		return new com.tcop.AuthenticationToken(username, password, captchaId, captcha, rememberMe,host);
	}
